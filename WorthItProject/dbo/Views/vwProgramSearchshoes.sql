...
CREATE VIEW [dbo].[vwProgramSearchshoes]
AS
SELECT        TOP (100) PERCENT dbo.Request.RequestStatusID, dbo.Request.RequestTypeID, dbo.Request.RequestID, dbo.Request.NeedbyDate, dbo.Request.ChildID, dbo.Request.CareGiverAdultID, dbo.Request.Serviced, 
                         ...
                         dbo.Campaign.CampaignStatusID, dbo.CampCabin.AgeGroupID, dbo.CampCabin.genderID, dbo.CampCabin.CampgroundRefID, dbo.CampCabin.MaxOcc, dbo.CampAgeGroup.AgeGroupDescription AS CabinAgeGroup, 
                         dbo.Campaign.CampaignTypeID
FROM            dbo.TribeDetail INNER JOIN
                         dbo.CampTribe ON dbo.TribeDetail.TribeID = dbo.CampTribe.TribeID RIGHT OUTER JOIN
                         dbo.Gender AS CabinGender INNER JOIN
                         dbo.CampCabin ON CabinGender.GenderID = dbo.CampCabin.genderID LEFT OUTER JOIN
                         dbo.CampAgeGroup ON dbo.CampCabin.AgeGroupID = dbo.CampAgeGroup.CampAgeGroupID ON dbo.TribeDetail.CabinID = dbo.CampCabin.CabinID RIGHT OUTER JOIN
                         dbo.Campaign INNER JOIN
                         dbo.Request INNER JOIN
                         dbo.ViewCampaignDetail ON dbo.Request.RequestID = dbo.ViewCampaignDetail.RequestID ON dbo.Campaign.CampaignID = dbo.Request.CampaignID ON 
                         dbo.CampCabin.CabinID = dbo.ViewCampaignDetail.CabinID LEFT OUTER JOIN
